...
#pragma warning restore 8618
        ...
        public void TestConnectPlayer()
        {
            ...
            Assert.AreEqual(new List<string> {HatRolePlayer.Value, HatRoleManager.Value, HatRoleSpectator.Value},
                joinedLobbyMessageClient0.AvailableRoles);
        }
        ...
        public void TestStartGame()
        {
            ...
            var gameAlreadyStartedMessage =
                (GameAlreadyStarted) _clients[2].Messages.Last(message => message is GameAlreadyStarted);
        ...
        public void TestDisconnect()
        {
            ...
            var lobbyUpdateMessageDisconnect =
                (LobbyUpdate) _clients[0].Messages.Last(message => message is LobbyUpdate);
        ...
        public void TestGameFinish()
        {
            ...
            var gameZeroClientFinishedMessage =
                (GameFinished) _clients[0].Messages.Last(message => message is GameFinished);
            var gameFirstClientFinishedMessage =
                (GameFinished) _clients[1].Messages.Last(message => message is GameFinished);
